package ru.mirea.rosyadi.akira.rizky.socketconnection;
...
public class MainActivity extends AppCompatActivity {
    private String TAG = ru.mirea.rosyadi.akira.rizky.socketconnection.MainActivity.class.getSimpleName();
